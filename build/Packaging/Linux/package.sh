...
case "$FORMAT" in
  ...
  rpm)
    ...
    sed -e "s/@VERSION@/$VERSION/g" -e "s/@ARCH@/$RPM_ARCH/g" "$ROOT/build/Packaging/Linux/voidstrap.spec.in" > "$RPMROOT/SPECS/voidstrap.spec"
